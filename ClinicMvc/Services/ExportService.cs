...
/// 
/// Можно е да дојдете до проблем со debugging така што кога ќе притисните
/// Export програмата да заврше(crash),ако го имате тој проблем треба да
/// одите во Tools->Options->Debugging->General->Enable Diagnostics Tools while debugging
/// ова опција не треба да ви е штиклирана.
/// </summary>
